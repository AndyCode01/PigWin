...
var Universal = require("./src/rutas/UniversalRuta");
var Cliente = require("./src/rutas/ClienteRuta");
var Apuesta = require("./src/rutas/ApuestaRuta");
var ContactoCliente = require("./src/rutas/ContactoClienteRuta");
var PuntoVenta = require("./src/rutas/PuntoVentaRuta");
var Partido = require("./src/rutas/PartidoRuta");
...
app.use("/Apuesta", Apuesta);
app.use("/ContactoCliente", ContactoCliente);
app.use("/PuntoVenta", PuntoVenta);
